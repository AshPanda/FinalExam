...
import page_object.page.CatalogPage;

import static page_object.ext.WebDriverShutter.WD_KEY;

public class CatalogPageResolver implements ParameterResolver {
    @Override
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        return parameterContext.getParameter().getType().equals(CatalogPage.class);
    }
